    ...
    <>
      <section className="h-body">
        ...
        <section className="grid-gallery">
          ...
          <div
            className="card"
            style={{ backgroundImage: "url('/images/grid-1.png')" }}
          ></div>

          {/* Card 2: Connect */}
          <div
            className="card"
            style={{ backgroundImage: "url('/images/grid-2.png')" }}
          ></div>
          ...
          <div
            className="card"
            style={{ backgroundImage: "url('/images/grid-4.png')" }}
          ></div>
        </section>
        ...
        <section className="definition">
          ...
          <p className="definition-text">
            A new standard for conscious living, describes products and
            practices that are responsibly made, cruelty-free, circular, low
            waste, and high quality.
          </p>
          <p className="example">
            <em>
              You can tell she uses clean skincare products, her skin is
              glowing!
            </em>
          </p>
        </section>
        ...
        <div className="chat-ui-box">
          ...
          <div className="chat-container">
            ...
            <div className="chat bot">
              If you're looking for vintage fashion, London is the place for it!
              Are you shopping online or in person?
            </div>

            <div className="chat user">In person</div>

            <div className="chat bot">
              <p>Sure! Here's some of the best vintage shops in London for a
                fun day out:</p>
              <ul>
              ...
              {[...Array(3)].map((_, i) => (
                <div className="avatars" key={i}>
                  {avatars.map((avatar, idx) => (
                    <div
                      className={`avatar ${
                        idx === avatars.length - 1 ? "last-avatar" : ""
                      }`}
                      key={`${i}-${idx}`}
                    >
                      <img
